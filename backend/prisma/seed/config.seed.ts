...
export const configVariables = {
  ...
  email: {
    ...
    resetPasswordSubject: {
      type: "string",
      defaultValue: "StellarTransfer password reset",
    },
    ...
    inviteSubject: {
      type: "string",
      defaultValue: "StellarTransfer invite",
    },
    inviteMessage: {
      type: "text",
      defaultValue:
        'Hey!\n\nYou were invited to StellarTransfer. Click this link to accept the invite: {url}\n\nYou can use the email "{email}" and the password "{password}" to sign in.\n\nStellarTransfer',
    },
  },
  smtp: {
    enabled: {
  ...
  legal: {
    ...
    imprintText: {
      type: "text",
      defaultValue:
        "StellarTransfer / 星闪包 is a private file transfer workspace. Configure your company imprint in the admin panel before production use.",
      secret: false,
    },
    imprintUrl: {
      type: "string",
