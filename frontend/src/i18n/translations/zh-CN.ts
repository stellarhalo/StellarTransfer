export default {
  ...
  "navbar.links.reverse": "闪包",
  "navbar.avatar.account": "我的账户",
  "navbar.avatar.admin": "管理",
  "navbar.avatar.signout": "登出",
  // END navbar
  // /
  "home.title": "<h>星闪包</h> 文件快传平台！",
  "home.description": "StellarTransfer 帮你更直接地上传、共享和取回文件。",
  ...
  "account.reverseShares.title": "闪包",
  "account.reverseShares.description": "闪包允许你创建一个特定共享链接，以便外部用户以此链接创建共享",
  "account.reverseShares.title.empty": "这里空空如也 👀",
  "account.reverseShares.description.empty": "你没有创建任何闪包",
  // showCreateReverseShareModal.tsx
  "account.reverseShares.modal.title": "创建闪包",
  ...
  "account.reverseShares.modal.max-size.label": "该闪包内所有文件大小的累积上限",
  "account.reverseShares.modal.send-email": "发送电子邮件通知",
  "account.reverseShares.modal.send-email.description": "当使用此闪包链接创建共享时，向您发送电子邮件通知。",
  ...
  "account.reverseShares.modal.public-access.description": "公开使用此闪包创建的共享。如果禁用，则只有您和共享创建者才能查看。",
  "account.reverseShare.never-expires": "这个闪包永不过期",
  "account.reverseShare.expires-on": "这个闪包将过期于 {expiration}",
  "account.reverseShares.modal.name.label": "闪包名称",
  "account.reverseShares.modal.name.placeholder": "输入闪包名称（可选）",
  "account.reverseShares.table.shares": "闪包名称",
  "account.reverseShares.table.remaining": "剩余使用次数",
  "account.reverseShares.table.max-size": "累计文件上限",
  "account.reverseShares.table.expires": "过期时间",
  "account.reverseShares.modal.reverse-share-link": "闪包链接",
  "account.reverseShares.modal.delete.title": "删除闪包链接",
  "account.reverseShares.modal.delete.description": "你真的想删除此闪包链接吗？链接下所有关联的共享都将被删除",
  ...
  "upload.reverse-share.error.invalid.title": "无效的闪包链接",
  "upload.reverse-share.error.invalid.description": "这个闪包已过期或无效。",
  // Dropzone.tsx
  "upload.dropzone.title": "添加文件",
  ...
  "upload.modal.completed.notified-reverse-share-creator": "我们已经通知闪包的创建者。您也可以通过其他方式将该链接手动分享给他们。",
  // END /upload
  // /share/[id]
  ...
  "admin.config.general.app-url": "App 地址",
  "admin.config.general.app-url.description": "StellarTransfer 星闪包的访问地址",
  ...
  "admin.config.cache.ttl.description": "缓存中信息保持的秒数。",
  ...
  "admin.config.cache.redis-enabled.description": "通常 Pingvin Share 在内存中缓存信息。如果运行多个 Pingvin Share 实例，则需要启用 Redis 缓存以便在实例之间共享缓存。",
  "admin.config.cache.redis-url": "Redis 地址",
  "admin.config.cache.redis-url.description": "连接用于缓存的 Redis 实例的地址。",
  ...
  "admin.config.email.reverse-share-subject": "闪包邮件通知主题",
  "admin.config.email.reverse-share-subject.description": "当有人使用您的闪包链接创建共享时发送电子邮件的主题",
  "admin.config.email.reverse-share-message": "闪包邮件通知内容",
  "admin.config.email.reverse-share-message.description": "当有人使用了你的闪包链接时，发送的通知内容。{shareUrl} 会被创建者的用户名和共享链接代替",
  ...
  "admin.config.share.share-id-length.description": "生成的共享 ID 的默认长度。该值也用于生成闪包的链接。低于 8 的值不安全。",
